...
int diss_account(int modified, FTYPE *Fit,FTYPE *U, struct of_geom *geom,FTYPE*pr)
{
  ...
  if(modified) diag_fixup_U(Ui,Uf,U,geom,0,COUNTUTOPRIMFAILCONV); // real dissipation, absolute limit of Lorentz factor
  else diag_fixup_U(Ui,Uf,U,geom,0,COUNTFLOORACT); // truncation dissipation
