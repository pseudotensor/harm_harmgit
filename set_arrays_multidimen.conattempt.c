...
void set_arrays_multidimen()
{
  ...
  GLOBALPOINT(ptemparrayalt) = (FTYPE PTRMACP0A1(ptemparrayalt,N1M,N2M,N3M,NPR)) (&(BASEMACP0A1(ptemparrayalt,N1BND,N2BND,N3BND,0)));
  FULLLOOP PLOOP(pliter,pl) GLOBALMACP0A1(ptemparrayalt,i,j,k,pl) = valueinit;
