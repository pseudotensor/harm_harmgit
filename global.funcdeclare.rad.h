...
extern int prad_fforlab(int whichdir, FTYPE *pp1, FTYPE *pp2, struct of_geom *ptrgeom);
...
extern int u2p_rad(FTYPE *uu, FTYPE *pp, struct of_geom *ptrgeom, PFTYPE *lpflag, PFTYPE *lpflagrad);
