...
extern FTYPE qoldarray[NUMEXTRATABLETYPES][NUMEOSDEGENQUANTITIESMEM1][NUMINDEPDIMENSMEM];
// whichtable: which table qarray led to (is ==NOTABLE for not within any table)
extern int whichtable[NUMEXTRATABLETYPES][NUMEOSDEGENQUANTITIESMEM1][2];
...
//
//////////
extern FTYPE resultold[MAXEOSPIPELINE];
...
extern int repeatedfun[MAXEOSPIPELINE];
