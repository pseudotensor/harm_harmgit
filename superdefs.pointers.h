...
struct of_state PTRDEFGLOBALMACP2A0(fluxstate,FILL,NUMLEFTRIGHT,N1M,N2M,N3M);
...
FTYPE PTRDEFGLOBALMACP4A0(pvcorninterp,FILL,COMPDIM,NUMCS,NUMCS,N1M+SHIFT1,N2M+SHIFT2,N3M+SHIFT3);
