...
#pragma omp for schedule(OPENMPSCHEDULE(),OPENMPCHUNKSIZE(blocksize))
	...
	if(i<-1 || j<-1 || k<-1 || i>N1 || j>N2 || k>N3 || i<0 && j<0 || i<0 && k<0 || j<0 && k<0 || i>N1-1 && j>N2-1 || i>N1-1 && k>N3-1 || j>N2-1 && k>N3-1 || ndtveclocal[1]<0.0 || ndtveclocal[2]<0.0 || ndtveclocal[3]<0.0) continue; //avoid too deep into boundary or if never set.
