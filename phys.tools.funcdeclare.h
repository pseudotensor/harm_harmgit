...
extern int set_vpar(FTYPE vpar, FTYPE gamma_max, struct of_geom *geom, FTYPE *pr);
extern int set_upar(FTYPE vpar_or_upar, FTYPE gamma_max, struct of_geom *geom, FTYPE *pr);
extern int compute_vpar(FTYPE *pr, struct of_geom *geom, FTYPE *vpar);
extern int compute_upar(FTYPE *pr, struct of_geom *geom, FTYPE *upar);
