  ...
  COMPZLOOP{
    ...
    PLOOP(pliter,pl){
      ...
      if(mapvar>=0){
        ...
        if(1&&(mapvar==YFL1 || mapvar==YFL2 || mapvar==YFL4)){ // just energy densities.  Can't apply to angular momenta that can be any sign.  Could apply to density, but doesn't seem to need it.
