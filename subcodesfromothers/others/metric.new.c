...
void mks_source_conn(FTYPE *ph, struct of_geom *ptrgeom, int ii, int jj,
		FTYPE *dU)
{
  int i=0, j=0, k=0, l=0;
...
dU[0]=0.;
dU[1]=0.5*dxdxp[1]*pow(sigma,-5.)*
    (r*pow(sigma,4.)*(bsq - 2.*en + 2.*en*gam - 
         2.*sigma*pow(dxdxp[2],2.)*pow(b[3],2.) + 
         (bsq + en*gam + rho)*pow(dxdxp[2],2.)*
          (pow(a,2.) + cos(2.*th)*pow(a,2.) + 2.*pow(r,2.))*pow(u[3],2.)) + 
      a*(pow(r,2.) - 1.*pow(a,2.)*pow(cos(th),2.))*
       (-1.*sigma*(b[1]*b[4] - 1.*(bsq + en*gam + rho)*u[1]*u[4])*
          (r*(2. + 3.*r)*pow(a,2.) + 
            cos(2.*th)*pow(a,2.)*((-2. + r)*r + pow(a,2.)) + pow(a,4.) + 
            2.*pow(r,4.)) - 2.*a*
          ((bsq + 2.*en*(-1. + gam))*r - 1.*dxdxp[1]*sigma*b[1]*b[2] + 
            0.5*dxdxp[1]*(bsq + en*gam + rho)*u[1]*u[2]*
             (pow(a,2.) + cos(2.*th)*pow(a,2.) + 2.*pow(r,2.)))*
          (r*(2. + r) + pow(a,2.)*pow(cos(th),2.)) - 
         4.*a*r*sigma*(-0.5*(bsq + 2.*en*(-1. + gam))*pow(sigma,-1.)*
             (r*(2. + r) + pow(a,2.)*pow(cos(th),2.)) - 1.*pow(b[1],2.) + 
            (bsq + en*gam + rho)*pow(u[1],2.)))*pow(sin(th),2.) + 
      dxdxp[1]*a*(pow(r,2.) - 1.*pow(a,2.)*pow(cos(th),2.))*
       (-4.*a*r*((bsq + 2.*en*(-1. + gam))*r - 1.*dxdxp[1]*sigma*b[1]*b[2] + 
            dxdxp[1]*(bsq + en*gam + rho)*sigma*u[1]*u[2])*
          pow(dxdxp[1],-1.) + 
         sigma*(r*(2. + 3.*r)*pow(a,2.) + 
            cos(2.*th)*pow(a,2.)*((-2. + r)*r + pow(a,2.)) + pow(a,4.) + 
            2.*pow(r,4.))*(-1.*b[2]*b[4] + (bsq + en*gam + rho)*u[2]*u[4] + 
            0.5*a*(bsq + 2.*en*(-1. + gam))*pow(dxdxp[1],-1.)*pow(sigma,-1.))
           - 1.*a*pow(dxdxp[1],-1.)*
          (r*(2. + r) + pow(a,2.)*pow(cos(th),2.))*
          ((bsq + 2.*en*(-1. + gam))*((-2. + r)*r + pow(a,2.)) - 
            2.*sigma*pow(dxdxp[1],2.)*pow(b[2],2.) + 
            (bsq + en*gam + rho)*pow(dxdxp[1],2.)*
             (pow(a,2.) + cos(2.*th)*pow(a,2.) + 2.*pow(r,2.))*pow(u[2],2.)))*
       pow(sin(th),2.) - 1.*sigma*
       (4.*r - 1.*pow(a,2.) + cos(2.*th)*pow(a,2.))*
       (pow(r,2.) - 1.*pow(a,2.)*pow(cos(th),2.))*
       (((bsq + 2.*en*(-1. + gam))*r - 1.*dxdxp[1]*sigma*b[1]*b[2] + 
            dxdxp[1]*(bsq + en*gam + rho)*sigma*u[1]*u[2])*pow(sigma,-1.)*
          (r*(2. + r) + pow(a,2.)*pow(cos(th),2.)) + 
         2.*r*(-0.5*(bsq + 2.*en*(-1. + gam))*pow(sigma,-1.)*
             (r*(2. + r) + pow(a,2.)*pow(cos(th),2.)) - 1.*pow(b[1],2.) + 
            (bsq + en*gam + rho)*pow(u[1],2.)) - 
         1.*a*(-1.*b[1]*b[4] + (bsq + en*gam + rho)*u[1]*u[4])*
          (r*(2. + r) + pow(a,2.)*pow(cos(th),2.))*pow(sin(th),2.)) + 
      (4.*a*r*sigma*(b[1]*b[4] - 1.*(bsq + en*gam + rho)*u[1]*u[4]) - 
         1.*a*(a*(bsq + 2.*en*(-1. + gam)) - 
            1.*dxdxp[1]*b[2]*b[4]*
             (pow(a,2.) + cos(2.*th)*pow(a,2.) + 2.*pow(r,2.)) + 
            dxdxp[1]*(bsq + en*gam + rho)*u[2]*u[4]*
             (pow(a,2.) + cos(2.*th)*pow(a,2.) + 2.*pow(r,2.)))*
          (r*(2. + r) + pow(a,2.)*pow(cos(th),2.)) + 
         0.5*(r*(2. + 3.*r)*pow(a,2.) + 
            cos(2.*th)*pow(a,2.)*((-2. + r)*r + pow(a,2.)) + pow(a,4.) + 
            2.*pow(r,4.))*((bsq + 2.*en*(-1. + gam))*pow(Csc(th),2.) - 
            2.*sigma*pow(b[4],2.) + 2.*(bsq + en*gam + rho)*sigma*pow(u[4],2.))
       ...
       (r*(a*(bsq + 2.*en*(-1. + gam)) - 2.*dxdxp[1]*sigma*b[2]*b[4] + 
            2.*dxdxp[1]*(bsq + en*gam + rho)*sigma*u[2]*u[4])*pow(sigma,-1.)\
          - 1.*(b[1]*b[4] - 1.*(bsq + en*gam + rho)*u[1]*u[4])*
          ((2. - 1.*r)*r - 1.*pow(a,2.)*pow(cos(th),2.)) - 
         2.*a*r*(0.5*(bsq + 2.*en*(-1. + gam))*pow(sigma,-1.)*
             pow(Csc(th),2.) - 1.*pow(b[4],2.) + 
            (bsq + en*gam + rho)*pow(u[4],2.))*pow(sin(th),2.)) + 
      a*sigma*(pow(a,2.)*(sigma - 2.*pow(r,2.)) + 
         2.*r*(pow(1.,2.)*(-2.*sigma + 4.*pow(r,2.)) + pow(sigma,2.)) + 
         cos(2.*th)*pow(a,2.)*(pow(r,2.) - 1.*pow(a,2.)*pow(cos(th),2.)))*
       pow(sin(th),2.)*(2.*r*(-1.*b[1]*b[4] + 
            (bsq + en*gam + rho)*u[1]*u[4]) + 
         dxdxp[1]*(-1.*b[2]*b[4] + (bsq + en*gam + rho)*u[2]*u[4] + 
            0.5*a*(bsq + 2.*en*(-1. + gam))*pow(dxdxp[1],-1.)*pow(sigma,-1.))
           *(r*(2. + r) + pow(a,2.)*pow(cos(th),2.)) - 
         1.*a*(r*(2. + r) + pow(a,2.)*pow(cos(th),2.))*
          (0.5*(bsq + 2.*en*(-1. + gam))*pow(sigma,-1.)*pow(Csc(th),2.) - 
            1.*pow(b[4],2.) + (bsq + en*gam + rho)*pow(u[4],2.))*
          pow(sin(th),2.)) + sigma*(pow(r,2.) - 1.*pow(a,2.)*pow(cos(th),2.))*
       (r*(2. + r) + pow(a,2.)*pow(cos(th),2.))*
       ((bsq + 2.*en*(-1. + gam))*sigma + 
         2.*((-2. + r)*r + pow(a,2.)*pow(cos(th),2.))*pow(b[1],2.) - 
         1.*(bsq + en*gam + rho)*
          (2.*(-2. + r)*r + pow(a,2.) + cos(2.*th)*pow(a,2.))*pow(u[1],2.) + 
         4.*r*b[1]*(-1.*dxdxp[1]*b[2] + a*b[4]*pow(sin(th),2.)) + 
         4.*r*(bsq + en*gam + rho)*u[1]*
          (dxdxp[1]*u[2] - 1.*a*u[4]*pow(sin(th),2.))) + 
      2.*sigma*(2.*r*(-1.*b[1]*b[2] + (bsq + en*gam + rho)*u[1]*u[2] + 
            (bsq + 2.*en*(-1. + gam))*r*pow(dxdxp[1],-1.)*pow(sigma,-1.)) + 
         dxdxp[1]*(r*(2. + r) + pow(a,2.)*pow(cos(th),2.))*
          (0.5*(bsq + 2.*en*(-1. + gam))*pow(dxdxp[1],-2.)*
             ((-2. + r)*r + pow(a,2.))*pow(sigma,-1.) - 1.*pow(b[2],2.) + 
            (bsq + en*gam + rho)*pow(u[2],2.)) - 
         1.*a*(-1.*b[2]*b[4] + (bsq + en*gam + rho)*u[2]*u[4] + 
            0.5*a*(bsq + 2.*en*(-1. + gam))*pow(dxdxp[1],-1.)*pow(sigma,-1.))
           *(r*(2. + r) + pow(a,2.)*pow(cos(th),2.))*pow(sin(th),2.))*
      ...
      4.*dxdxp[1]*sigma*(pow(r,2.) - 1.*pow(a,2.)*pow(cos(th),2.))*
       ...
       (b[1]*b[2]*((-2. + r)*r + pow(a,2.)*pow(cos(th),2.)) - 
         2.*dxdxp[1]*r*pow(b[2],2.) + 2.*a*r*b[2]*b[4]*pow(sin(th),2.) + 
         0.5*(bsq + en*gam + rho)*u[2]*
          (-1.*u[1]*(2.*(-2. + r)*r + pow(a,2.) + cos(2.*th)*pow(a,2.)) + 
            4.*r*(dxdxp[1]*u[2] - 1.*a*u[4]*pow(sin(th),2.)))) - 
      1.*dxdxp[2]*a*cos(th)*pow(sigma,2.)*
       (r*(2. + r) + pow(a,2.)*pow(cos(th),2.))*
       (4.*a*r*(b[1]*b[3] - 1.*(bsq + en*gam + rho)*u[1]*u[3]) - 
         1.*(b[3]*b[4] - 1.*(bsq + en*gam + rho)*u[3]*u[4])*
          (r*(2. + 3.*r)*pow(a,2.) + 
            cos(2.*th)*pow(a,2.)*((-2. + r)*r + pow(a,2.)) + pow(a,4.) + 
            2.*pow(r,4.)) + 2.*dxdxp[1]*a*
          (b[2]*b[3] - 1.*(bsq + en*gam + rho)*u[2]*u[3])*
          (r*(2. + r) + pow(a,2.)*pow(cos(th),2.)))*sin(th) - 
      2.*dxdxp[2]*cos(th)*pow(a,2.)*pow(sigma,3.)*
       (2.*r*(-1.*b[1]*b[3] + (bsq + en*gam + rho)*u[1]*u[3]) + 
         dxdxp[1]*(-1.*b[2]*b[3] + (bsq + en*gam + rho)*u[2]*u[3])*
          (r*(2. + r) + pow(a,2.)*pow(cos(th),2.)) - 
         1.*a*(-1.*b[3]*b[4] + (bsq + en*gam + rho)*u[3]*u[4])*
          (r*(2. + r) + pow(a,2.)*pow(cos(th),2.))*pow(sin(th),2.))*sin(th) + 
      2.*dxdxp[2]*r*(b[1]*b[3] - 1.*(bsq + en*gam + rho)*u[1]*u[3])*
       pow(a,2.)*pow(sigma,3.)*sin(2.*th) + 
      2.*dxdxp[1]*dxdxp[2]*r*
       (b[2]*b[3] - 1.*(bsq + en*gam + rho)*u[2]*u[3])*pow(a,2.)*pow(sigma,3.)*
       sin(2.*th) - 2.*dxdxp[2]*r*pow(a,2.)*pow(sigma,2.)*
       (-2.*dxdxp[1]*r*(b[2]*b[3] - 1.*(bsq + en*gam + rho)*u[2]*u[3]) - 
         1.*(b[1]*b[3] - 1.*(bsq + en*gam + rho)*u[1]*u[3])*
          ((2. - 1.*r)*r - 1.*pow(a,2.)*pow(cos(th),2.)) + 
         2.*a*r*(b[3]*b[4] - 1.*(bsq + en*gam + rho)*u[3]*u[4])*pow(sin(th),2.)
         )*sin(2.*th) - 2.*dxdxp[2]*a*
       (b[3]*b[4] - 1.*(bsq + en*gam + rho)*u[3]*u[4])*pow(sigma,3.)*sin(th)*
       (r*(2. + r)*sigma*cos(th) + sigma*pow(a,2.)*pow(cos(th),3.) + 
         r*pow(a,2.)*sin(th)*sin(2.*th)));
dU[2]=0.5*(-2.*dxdxp[1]*r*
       (b[2]*b[3] - 1.*(bsq + en*gam + rho)*u[2]*u[3])*pow(dxdxp[2],2.) - 
      ...
      4.*dxdxp[2]*r*cos(th)*pow(a,3.)*pow(sigma,-3.)*
       (r*(a*(bsq + 2.*en*(-1. + gam)) - 2.*dxdxp[1]*sigma*b[2]*b[4] + 
         ...
         2.*a*r*(0.5*(bsq + 2.*en*(-1. + gam))*pow(sigma,-1.)*
             pow(Csc(th),2.) - 1.*pow(b[4],2.) + 
            (bsq + en*gam + rho)*pow(u[4],2.))*pow(sin(th),2.))*pow(sin(th),3.)
       ...
       (-1.*sigma*(b[1]*b[4] - 1.*(bsq + en*gam + rho)*u[1]*u[4])*
         ...
         4.*a*r*sigma*(-0.5*(bsq + 2.*en*(-1. + gam))*pow(sigma,-1.)*
             (r*(2. + r) + pow(a,2.)*pow(cos(th),2.)) - 1.*pow(b[1],2.) + 
            (bsq + en*gam + rho)*pow(u[1],2.)))*sin(th) - 
      1.*dxdxp[1]*dxdxp[2]*a*cos(th)*pow(sigma,-4.)*
       ...
       (2.*r*(-1.*b[1]*b[2] + (bsq + en*gam + rho)*u[1]*u[2] + 
            (bsq + 2.*en*(-1. + gam))*r*pow(dxdxp[1],-1.)*pow(sigma,-1.)) + 
         dxdxp[1]*(r*(2. + r) + pow(a,2.)*pow(cos(th),2.))*
          (0.5*(bsq + 2.*en*(-1. + gam))*pow(dxdxp[1],-2.)*
             ((-2. + r)*r + pow(a,2.))*pow(sigma,-1.) - 1.*pow(b[2],2.) + 
         ...
         1.*a*(-1.*b[2]*b[4] + (bsq + en*gam + rho)*u[2]*u[4] + 
            0.5*a*(bsq + 2.*en*(-1. + gam))*pow(dxdxp[1],-1.)*pow(sigma,-1.))
           *(r*(2. + r) + pow(a,2.)*pow(cos(th),2.))*pow(sin(th),2.))*sin(th)\
       + (bsq - 2.*en + 2.*en*gam - 2.*sigma*pow(dxdxp[2],2.)*pow(b[3],2.) + 
         (bsq + en*gam + rho)*pow(dxdxp[2],2.)*
          (pow(a,2.) + cos(2.*th)*pow(a,2.) + 2.*pow(r,2.))*pow(u[3],2.))*
      ...
      1.*dxdxp[2]*r*pow(a,2.)*pow(sigma,-3.)*
       ((bsq + 2.*en*(-1. + gam))*sigma + 
         ...
         4.*r*b[1]*(-1.*dxdxp[1]*b[2] + a*b[4]*pow(sin(th),2.)) + 
         4.*r*(bsq + en*gam + rho)*u[1]*
          (dxdxp[1]*u[2] - 1.*a*u[4]*pow(sin(th),2.)))*sin(2.*th) - 
      2.*dxdxp[1]*dxdxp[2]*r*pow(a,2.)*pow(sigma,-3.)*
       (b[1]*b[2]*((-2. + r)*r + pow(a,2.)*pow(cos(th),2.)) - 
         2.*dxdxp[1]*r*pow(b[2],2.) + 2.*a*r*b[2]*b[4]*pow(sin(th),2.) + 
         0.5*(bsq + en*gam + rho)*u[2]*
          (-1.*u[1]*(2.*(-2. + r)*r + pow(a,2.) + cos(2.*th)*pow(a,2.)) + 
            4.*r*(dxdxp[1]*u[2] - 1.*a*u[4]*pow(sin(th),2.))))*sin(2.*th) + 
      dxdxp[2]*pow(sigma,-2.)*
       (4.*a*r*sigma*(b[1]*b[4] - 1.*(bsq + en*gam + rho)*u[1]*u[4]) - 
         1.*a*(a*(bsq + 2.*en*(-1. + gam)) - 
            1.*dxdxp[1]*b[2]*b[4]*
