...
void set_arrays_multidimen()
{
...
#if(N1>1)
  GLOBALPOINT(F1) = (FTYPE PTRMACP0A1(F1,N1M,N2M,N3M,NPR)) (&(BASEMACP0A1(F1,SHIFT1+N1BND,SHIFT2+N2BND,SHIFT3+N3BND,0)));
  FULLLOOP PLOOP(pliter,pl){
    GLOBALMACP0A1(F1,i,j,k,pl) = valueinit;
  }
#endif
#if(N2>1)
  GLOBALPOINT(F2) = (FTYPE PTRMACP0A1(F2,N1M,N2M,N3M,NPR)) (&(BASEMACP0A1(F2,SHIFT1+N1BND,SHIFT2+N2BND,SHIFT3+N3BND,0)));
  FULLLOOP PLOOP(pliter,pl){
    GLOBALMACP0A1(F2,i,j,k,pl) = valueinit;
  }
#endif
#if(N3>1)
  GLOBALPOINT(F3) = (FTYPE PTRMACP0A1(F3,N1M,N2M,N3M,NPR)) (&(BASEMACP0A1(F3,SHIFT1+N1BND,SHIFT2+N2BND,SHIFT3+N3BND,0)));
  FULLLOOP PLOOP(pliter,pl){
...
#endif
#if(N2>1)
  GLOBALPOINT(F2EM) = (FTYPE PTRMACP0A1(F2EM,N1M,N2M,N3M,NPR)) (&(BASEMACP0A1(F2EM,SHIFT1+N1BND,SHIFT2+N2BND,SHIFT3+N3BND,0)));
  FULLLOOP PLOOP(pliter,pl){
    GLOBALMACP0A1(F2EM,i,j,k,pl) = valueinit;
  }
#endif
#if(N3>1)
  GLOBALPOINT(F3EM) = (FTYPE PTRMACP0A1(F3EM,N1M,N2M,N3M,NPR)) (&(BASEMACP0A1(F3EM,SHIFT1+N1BND,SHIFT2+N2BND,SHIFT3+N3BND,0)));
  FULLLOOP PLOOP(pliter,pl){
...
#if( HIGHERORDERMEM )
  GLOBALPOINT(fluxvectemp) = (FTYPE PTRMACP0A1(fluxvectemp,N1M,N2M,N3M,NPR)) (&(BASEMACP0A1(fluxvectemp,N1BND,N2BND,N3BND,0)));
  GLOBALPOINT(Fa) = (FTYPE PTRMACP0A1(Fa,N1M,N2M,N3M,NPR)) (&(BASEMACP0A1(Fa,N1BND,N2BND,N3BND,0)));
  GLOBALPOINT(Fb) = (FTYPE PTRMACP0A1(Fb,N1M,N2M,N3M,NPR)) (&(BASEMACP0A1(Fb,N1BND,N2BND,N3BND,0)));
  ...
  GLOBALPOINT(a2cin)  = (FTYPE PTRMACP0A1(Fa,N1M,N2M,N3M,NPR)) (&(BASEMACP0A1(Fa,N1BND,N2BND,N3BND,0)));
  GLOBALPOINT(a2cout) = (FTYPE PTRMACP0A1(Fb,N1M,N2M,N3M,NPR)) (&(BASEMACP0A1(Fb,N1BND,N2BND,N3BND,0)));
  ...
  GLOBALPOINT(pflagfailorig) = (PFTYPE PTRMACP0A0(pflagfailorig,N1M,N2M,N3M)) (&(BASEMACP0A0(pflagfailorig,N1BND,N2BND,N3BND)));
  ...
  GLOBALPOINT(Xstore) = (FTYPE PTRMACP1A1(Xstore,FILL,N1M+SHIFT1,N2M+SHIFT2,N3M+SHIFT3,NDIM)) (&(BASEMACP1A1(Xstore,0,N1BND,N2BND,N3BND,0))); // Xstore is not reduced if CARTMINKMETRIC
  GLOBALPOINT(Vstore) = (FTYPE PTRMETMACP1A1(Vstore,FILL,N1M+SHIFT1,N2M+SHIFT2,N3M+SHIFT3,NDIM)) (&(BASEMETMACP1A1(Vstore,0,N1BND,N2BND,N3BND,0)));
#endif
