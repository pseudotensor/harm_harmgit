...
# NO!  1/29/16
# Now with correct x,y,z orientation so really points in directions and signs expected, order is:
#  East/West: U2   = Bz
#  North/South: W2 = Bx
#  Vertical: V2    = By
...
# W2,U2,V2 = Bx,By,Bz
#
# That is, association between internal vis5d+ compass direction + vertical is to same B field components.  All that changes is dummy labels.
