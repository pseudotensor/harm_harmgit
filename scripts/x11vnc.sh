...
###########################################
# use below if user hasn't logged in yet.
# ps -auxwf | grep X  will give which display currently on

#nohup x11vnc -noxdamage -deferupdate none -wait none -defer none -rfbauth ~/.vnc/passwd -auth /var/run/lightdm/root/:0 -display :0  -forever -nevershared -bg -rfbport 5904 -o logfilenew.x11vnc.txt &
#nohup x11vnc -noxdamage -deferupdate none -wait none -defer none -rfbauth ~/.vnc/passwd -auth /var/run/lightdm/root/:2 -display :2  -forever -nevershared -bg -rfbport 5904 -o logfilenew.x11vnc.txt &
#nohup x11vnc -noxdamage -deferupdate none -wait none -defer none -rfbauth ~/.vnc/passwd -auth /var/run/lightdm/root/:3 -display :3  -forever -nevershared -bg -rfbport 5904 -o logfilenew.x11vnc.txt &


#    nohup x11vnc -noxdamage -deferupdate none -wait none -defer none -rfbauth ~/.vnc/passwd  -forever -bg -rfbport 5904 -display :0 -o logfilenew.x11vnc.txt &
