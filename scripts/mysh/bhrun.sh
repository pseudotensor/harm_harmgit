...
#  echo "a"
#done
#((rsh -l $masteruser $masternode "mkdir -p $p4path" ; rcp $newpgfile $masteruser@$masternode:$masterpath ; rsh -l $masteruser $masternode "$p4prog $a -p4pg $newpgfile -p4wd $masterpath" 2>&1 ) &)
((ssh -l $masteruser $masternode "mkdir -p $p4path" ; scp $newpgfile $masteruser@$masternode:$masterpath ; ssh -l $masteruser $masternode "$p4prog $a -p4pg $newpgfile -p4wd $masterpath" 2>&1 ) &)
