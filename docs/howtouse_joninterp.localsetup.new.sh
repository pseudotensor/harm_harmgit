...
if [ $system -eq 4 ]
then
    joninterpcodedir=/data/jon/thickdisk7_vis5d/harmgit/
    basedir=/data/jon/thickdisk7_vis5d/harmgit/$modelname/
    iinterpprogname=/data/jon/thickdisk7_vis5d/harmgit/run/iinterp
    bin2txtprogname=/data/jon/thickdisk7_vis5d/harmgit/run/bin2txt
