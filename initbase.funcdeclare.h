...
extern int get_vpot_fluxctstag_primecoords(int i, int j, int k, FTYPE (*prim)[NSTORE2][NSTORE3][NPR], FTYPE *vpot);

extern int init_vpot_justAcov(FTYPE (*prim)[NSTORE2][NSTORE3][NPR], FTYPE (*A)[NSTORE1+SHIFTSTORE1][NSTORE2+SHIFTSTORE2][NSTORE3+SHIFTSTORE3]);
...
extern int init_vpot_user(int *whichcoord, int l, int i, int j, int k, int loc, FTYPE (*p)[NSTORE2][NSTORE3][NPR], FTYPE *V, FTYPE *A);
