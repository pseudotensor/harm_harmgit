...
//  else
  ...
  //  else
  NEWT_TOL_ULTRAREL_VAR=NEWT_TOL_ULTRAREL;
  ...
  //  else
  EXTRA_NEWT_ITER_VAR=EXTRA_NEWT_ITER;
  ...
  //  else
  EXTRA_NEWT_ITER_ULTRAREL_VAR=EXTRA_NEWT_ITER_ULTRAREL;
