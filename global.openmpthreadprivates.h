...
#define OPENMPKAZEOSPRIVATE kazii,kazjj,kazkk,kazll,kaziio,kazjjo,kazkko,kazllo,kazstartiii,kazstartjjj,kazstartkkk,kazstartlll,kazendiii,kazendjjj,kazendkkk,kazendlll,kazdj,kazdk,kazdl,gottable,whichtable,indexarray,qoldarray,resultold,repeatedfun,extrasold,processedold,qoldarray
...
#define OPENMPGLOBALPRIVATEFORINVERSION copyin(OPENMPGLOBALPRIVATEFORSTATEANDGEOM)
// geom but not state:
