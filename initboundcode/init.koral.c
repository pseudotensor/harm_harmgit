  ...
  if(WHICHPROBLEM==RADWAVE){
    ...
    if(RADWAVE_NWAVE==5){ //sound wave with radiation set up according to Jiang+12
      ...
      if(RADWAVE_NUMERO==103) { // radiation-modified sound wave
        ...
        RADWAVE_DRRE=0.001*RADWAVE_RHOFAC;
        RADWAVE_DRIM=0*RADWAVE_RHOFAC;
        RADWAVE_DVRE=0.*RADWAVE_RHOFAC;
        RADWAVE_DVIM=0.0027041619509414645*RADWAVE_RHOFAC;
        RADWAVE_DV2RE=0*RADWAVE_RHOFAC;
        RADWAVE_DV2IM=0*RADWAVE_RHOFAC;
        RADWAVE_DURE=-0.006746168441096415*RADWAVE_RHOFAC;
        RADWAVE_DUIM=0.*RADWAVE_RHOFAC;
        RADWAVE_DB2RE=0*RADWAVE_RHOFAC;
        RADWAVE_DB2IM=0*RADWAVE_RHOFAC;
        RADWAVE_DERE=0.006083876416727861*RADWAVE_RHOFAC;
        RADWAVE_DEIM=0.*RADWAVE_RHOFAC;
        RADWAVE_DFRE=0.*RADWAVE_RHOFAC;
        RADWAVE_DFIM=-0.0018387138449392983*RADWAVE_RHOFAC;
        RADWAVE_DF2RE=0*RADWAVE_RHOFAC;
        RADWAVE_DF2IM=0*RADWAVE_RHOFAC;
        RADWAVE_OMRE=0.;
        RADWAVE_OMIM=16.990750638389496;
        RADWAVE_DTOUT1=2*M_PI/RADWAVE_OMRE/10.;
      }
      ...
      if(RADWAVE_NUMERO==1103){ //radiation-modified slow magnetosonic, opt THICK
        ...
        RADWAVE_DRIM=0*RADWAVE_RHOFAC;
        RADWAVE_DVRE=0.*RADWAVE_RHOFAC;
        RADWAVE_DVIM=0.0027041876756772943*RADWAVE_RHOFAC;
        RADWAVE_DV2RE=0.*RADWAVE_RHOFAC;
        RADWAVE_DV2IM=0.000030497860629875172*RADWAVE_RHOFAC;
        RADWAVE_DURE=-0.006822487263056285*RADWAVE_RHOFAC;
        RADWAVE_DUIM=0.*RADWAVE_RHOFAC;
        RADWAVE_DB2RE=0.00009962218831534363*RADWAVE_RHOFAC;
        RADWAVE_DB2IM=0.*RADWAVE_RHOFAC;
        RADWAVE_DERE=0.006152603286696507*RADWAVE_RHOFAC;
        RADWAVE_DEIM=0.*RADWAVE_RHOFAC;
        RADWAVE_DFRE=0.*RADWAVE_RHOFAC;
        RADWAVE_DFIM=-0.0018592613996624649*RADWAVE_RHOFAC;
        RADWAVE_DF2RE=0.*RADWAVE_RHOFAC;
        RADWAVE_DF2IM=-1.806039447479648e-7*RADWAVE_RHOFAC;
        RADWAVE_OMRE=0.;
        RADWAVE_OMIM=16.990912271671693;
        RADWAVE_DTOUT1=2*M_PI/RADWAVE_OMRE/10.;
      }
...
int init_dsandvels_koral(int *whichvel, int*whichcoord, int i, int j, int k, FTYPE *pr, FTYPE *pstag)
{
  ...
  if(WHICHPROBLEM==RADWAVE){
    ...
    if(RADWAVE_NWAVE==5){
      ...
      FTYPE cs=1/RADWAVE_CC;
      vx=0. + exp(-RADWAVE_OMIM*time)*(RADWAVE_DVRE*cos(RADWAVE_OMRE*time-RADWAVE_KK*xx)-RADWAVE_DVIM*sin(RADWAVE_OMRE*time-RADWAVE_KK*xx)) ; //RADWAVE_DVRE absolute!
      vy=0. + exp(-RADWAVE_OMIM*time)*(RADWAVE_DV2RE*cos(RADWAVE_OMRE*time-RADWAVE_KK*xx)-RADWAVE_DV2IM*sin(RADWAVE_OMRE*time-RADWAVE_KK*xx)) ; //RADWAVE_DVRE absolute!
      Bx=RADWAVE_B0;
      By=RADWAVE_B0 + exp(-RADWAVE_OMIM*time)*(RADWAVE_DB2RE*cos(RADWAVE_OMRE*time-RADWAVE_KK*xx)-RADWAVE_DB2IM*sin(RADWAVE_OMRE*time-RADWAVE_KK*xx)) ; //RADWAVE_DVRE absolute!
      ERAD=RADWAVE_ERAD+exp(-RADWAVE_OMIM*time)*(RADWAVE_DERE*cos(RADWAVE_OMRE*time-RADWAVE_KK*xx)-RADWAVE_DEIM*sin(RADWAVE_OMRE*time-RADWAVE_KK*xx));
      Fx=0. + exp(-RADWAVE_OMIM*time)*(RADWAVE_DFRE*cos(RADWAVE_OMRE*time-RADWAVE_KK*xx)-RADWAVE_DFIM*sin(RADWAVE_OMRE*time-RADWAVE_KK*xx));
      Fy=0. + exp(-RADWAVE_OMIM*time)*(RADWAVE_DF2RE*cos(RADWAVE_OMRE*time-RADWAVE_KK*xx)-RADWAVE_DF2IM*sin(RADWAVE_OMRE*time-RADWAVE_KK*xx));
      Fz=0.;
