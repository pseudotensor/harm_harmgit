...
// from init.nsbh.c
extern int bound_prim_user_dir_nsbh(int boundstage, int finalstep, SFTYPE boundtime, int whichdir, int boundvartype, FTYPE (*prim)[NSTORE2][NSTORE3][NPR]);
...
int bound_prim_user_dir(int boundstage, int finalstep, SFTYPE boundtime, int whichdir, int boundvartype, FTYPE (*prim)[NSTORE2][NSTORE3][NPR])
{
  ...
  bound_prim_user_dir_nsbh(boundstage,finalstep,boundtime,whichdir,boundvartype,prim);
...
int bound_pstag_user_dir(int boundstage, int finalstep, SFTYPE boundtime, int whichdir, int boundvartype, FTYPE (*prim)[NSTORE2][NSTORE3][NPR])
{
  ...
  bound_pstag_user_dir_nsbh(boundstage,finalstep,boundtime,whichdir,boundvartype,prim);
...
int bound_prim_user_after_mpi_dir(int boundstage, int finalstep, SFTYPE boundtime, int whichdir, FTYPE (*prim)[NSTORE2][NSTORE3][NPR])
{
