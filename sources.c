...
int sourcephysics(FTYPE *pi, FTYPE *pr, FTYPE *pf, int *didreturnpf, int *eomtype, struct of_geom *ptrgeom, struct of_state *q, FTYPE *Ugeomfreei, FTYPE *Ugeomfreef, FTYPE *CUf, FTYPE *dUother, FTYPE (*dUcomp)[NPR])
{
  ...
  extern int koral_source_rad(int whichsourcemethod, FTYPE *pi, FTYPE *pr, FTYPE *pf, int *didreturnpf, int *eomtype, FTYPE *Ui, FTYPE *Uf, FTYPE *CUf, struct of_geom *geom, struct of_state *q, FTYPE *dUother, FTYPE (*dUcomp)[NPR]);
  ...
  *didreturnpf=0;
  ...
  if(cooling==COOLGAMMIETHINDISK){
    ...
    return(koral_source_rad(WHICHRADSOURCEMETHOD, pi, pr, pf, didreturnpf, eomtype, Ugeomfreei, Ugeomfreef, CUf, ptrgeom, q, dUother, dUcomp));
  }
  else{
    // random physics
