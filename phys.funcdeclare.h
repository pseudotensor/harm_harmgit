...
extern int sourcephysics(FTYPE *ph, FTYPE *pf, int *didreturnpf, struct of_geom *geom, struct of_state *q, FTYPE *Ugeomfreei, FTYPE *Ugeomfreef, FTYPE* CUf, FTYPE *dUother, FTYPE (*dUcomp)[NPR]);
...
extern int source(FTYPE *pa,  FTYPE *pf, int *didreturnpf, struct of_geom *geom, struct of_state *q, FTYPE *Ui, FTYPE *Uf, FTYPE *CUf, FTYPE *dUriemann,
